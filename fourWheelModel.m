...
function xdot = fourWheelModel(xcur, ctlSig)
...
% controlSignal = [cs_vel; cs_psi];
V(1,1) = (ctlSig(1,1) + ctlSig(2,1));  % Front LHS V
V(2,1) = (ctlSig(1,1) + ctlSig(2,1));  % Back LHS V
V(3,1) = (ctlSig(1,1) - ctlSig(2,1));  % Front RHS V
V(4,1) = (ctlSig(1,1) - ctlSig(2,1));  % Back RHS V
